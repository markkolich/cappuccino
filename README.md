...
Written in Java, but doesn't mean you need a JVM installed to run Cappuccino &mdash; the binary ships with a self-contained JRE (that you never see and don't have to install) thanks to 7zip SFX.
